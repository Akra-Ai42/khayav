                        ...
                        <div className="relative w-full max-w-md h-[100vh] sm:h-[800px] bg-[#0b141a] sm:rounded-[3rem] shadow-2xl overflow-hidden border-0 sm:border-[8px] border-slate-900 flex flex-col">
                            <header className="pt-12 pb-5 px-6 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 shadow-xl z-10">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button onClick={() => window.location.reload()} className="p-2 bg-white/10 rounded-full hover:bg-white/20"><i data-lucide="refresh-ccw" className="w-4 h-4"></i></button>
                                </div>
                                <div className="mt-4 flex gap-2 overflow-x-auto no-scrollbar pb-1">
                                    <span className="bg-white/10 px-3 py-1 rounded-full text-[10px] flex items-center gap-1"><i data-lucide="map-pin" className="w-3 h-3"></i>Vieux-Port</span>
                                    {sessionData.date && <span className="bg-green-500/30 px-3 py-1 rounded-full text-[10px] flex items-center gap-1 animate-pulse"><i data-lucide="calendar" className="w-3 h-3"></i>{sessionData.date}</span>}
                                    {sessionData.heure && <span className="bg-blue-500/30 px-3 py-1 rounded-full text-[10px] flex items-center gap-1 animate-pulse"><i data-lucide="clock" className="w-3 h-3"></i>{sessionData.heure}</span>}
                                    {sessionData.couverts && <span className="bg-orange-500/30 px-3 py-1 rounded-full text-[10px] flex items-center gap-1 animate-pulse"><i data-lucide="users" className="w-3 h-3"></i>{sessionData.couverts} pers</span>}
                                </div>
                            </header>
